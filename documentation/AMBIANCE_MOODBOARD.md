...
![Driller: planes, threshold, and directional space](./moodboard/video-games/driller_05.png)

*A few masses and diagonals establish hostility, passage, and the need to infer what lies beyond the current view.*

![The Sentinel: minimal space and threat](./moodboard/video-games/sentinel_03.png)

*An almost empty space can remain legible, tense, and mentally active.*

![Tau Ceti: instrumental viewport](<./moodboard/video-games/Tau Ceti - 4880.png>)

*The world is not presented directly. It is read through an apparatus.*

![The Pawn: text and image carrying the world together](./moodboard/video-games/pawn_06.png)
...
![In the Walls of Eryx: prospector meeting an invisible plane](./moodboard/origins/Weird_Tales_v34n04_-_In_the_Walls_of_Eryx-BY-Harry_Ferman.png)
...
![Beyond the Walls of Eryx: title and proliferating wire space](./moodboard/origins/beyond_480e.51129.png)
...
![Beyond the Walls of Eryx: linked bodies and collapsing mesh](./moodboard/origins/beyond_c582.51136.png)
...
![Within the Mesh: arrival over Venus](./moodboard/origins/within_7227.90273.png)
...
![Within the Mesh: navigated wall structure](./moodboard/origins/within_f899.90278.png)
...
![Enigma: computed image as event](./moodboard/demoscene/Enigma_003.png)

*Few elements can carry strong technical wonder when their computation is perceptible.*

![Origin Complex: modular architecture and passage](./moodboard/demoscene/Origin_Complex_008.png)

*Repeated modules, sharp depth, and an uncertain beyond make architecture a transit system rather than a complete place.*

![Substance: abstract corridor](./moodboard/demoscene/Substance_000.png)

*Almost nothing is shown, yet direction and spatial pressure already exist.*

![Hardwired: geometry as technical performance](./moodboard/demoscene/Hardwired_005.png)

*The object, environment, and demonstration of computation become inseparable.*

![Amiga Desert Dreams: line and promise of passage](./moodboard/demoscene/amiga-desert-dreams_0003.png)
...
![Voyage: a few lines produce volume](./moodboard/demoscene/Voyage_000.png)
...
![Real Complex: horizon and active emptiness](./moodboard/demoscene/Real_Complex_007.png)
...
![Uninvited: scene, verbs, inventory, and text](./moodboard/video-games/uninvited_02.png)

*Compartmentalization exposes the system's different forms of knowledge.*

![Captain Blood: viewport embedded in a machine](./moodboard/video-games/captain_blood_14.png)
...
![Origin Complex: instrumented architecture and threshold](./moodboard/demoscene/Origin_Complex_012.png)

*Sparse surfaces, doors, and a strong viewing apparatus remain close to the desired current grammar.*

![Drakkhen: minimal exterior with high fictional charge](./moodboard/video-games/drakkhen_04.png)
